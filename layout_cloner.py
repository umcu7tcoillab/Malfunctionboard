...
#https://github.com/tlantela/KiCAD_layout_cloner
#get bom file form the sheet
#execfile(r'C:\Users\Dimitri\Documents\Projects\PCB\Malfunctionboard-UMCU\layout_cloner.py')
...
templateReferences = ["U201", "R201", "R202", "R203", "R204", "R205", "R206", "D201", "D202", "L201", "L202", "L203", "L204", "C201", "C202", "C203", "C204", "C205", "Q201", "Q202", "J201", "J202"]
...
inputBoardFile = r'C:\Users\Dimitri\Documents\Projects\PCB\Malfunctionboard-UMCU\Malfunctionboard UMCU.kicad_pcb'
# Output file. Original file remains unmodified.
outputBoardFile = r'C:\Users\Dimitri\Documents\Projects\PCB\Malfunctionboard-UMCU\Malfunctionboard UMCU_cloned.kicad_pcb'

templateRefModulo = 100;  # Difference in the reference numbers between hierarchical sheets
templateRefStart = 1;	 # Starting point of numbering in the first hierarchical sheet
move_dx = FromMM(14.8)	# Spacing between clones in x direction
...
for templateRef in templateReferences: # For each module in the template subschema
	...
	for i in range(0, numberOfClones-1):
		#if templateReferenceNumber == '201':
		#	#print(templateReferenceNumber)
		#	cloneRefNumber = int(templateReferenceNumber) + (i+1)*1
...
cloneTracks = []
for track in tracks:
	if track.HitTest(templateRect): # and track.GetLayer() is not 31:	 #31=bottom, dimitri						# Find tracks which touch the comment zone
